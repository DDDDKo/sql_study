...
-- VIEW는 물리적으로 데이터 복사되는 것이 아니고 논리적으로 결과를 
-- 불러오는 것이기 때문에 VIEW 자체로 INSERT, UPDATE, DELETE가 불가능
INSERT INTO employee_view VALUES(10,'김길동','MM','물류부','010-111-1114');
...
CREATE INDEX department_tel_number_index_1
ON department (name, tel_number);

SELECT * FROm department 
WHERE name = '인사부' AND tel_number ='010-1111-1111';
SELECT * FROm department 
WHERE tel_number ='010-1111-1111' AND name = '인사부';

DROP INDEX department_tel_number_index ON department;
