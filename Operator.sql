...
-- IS : 좌항이 우항과 같으면 ture(키워드일때)
-- IS NOT : 좌항이 우항과 다르면 true(키워드일때)
...
-- BETWEEN min AND max : 좌항이 min보다 크거나 같으며면서 max보다 작거나 같으면 true
-- NOT BETWEEN min AND max : 좌항이 min보다 작거나 MAX보다 크면 ture
...
SELECT * FROM jeju WHERE observe_date IN ('2023-07-01', '2023-08-01', '2023-09-01', '2023-10-01', '2023-11-01', '2023-012-01');
SELECT * FROM jeju WHERE observe_date NOT IN ('2023-07-01', '2023-08-01', '2023-09-01', '2023-10-01', '2023-11-01', '2023-012-01');
...
-- ORDER BY column1, ORDER BY column2 하면
-- 1에 대해서 정렬하고 1로 정렬된 컬럼을 묶어서 2를 정렬 
...
-- 쿼리 검색시 1. FROM 2. WHERE 3. ORDER 4. SELECT 순으로 진행
